...
def firefox_all(request):
    ...
    context = {
        ...
        'android_release_full_builds': [{'locale': 'all', 'name_en': 'Multi-locale', 'name_native': 'Multi-locale', 'platforms': {'android': {'download_url': '#'}}}],
        ...
        'ios_release_full_builds': [{'locale': 'all', 'name_en': 'Multi-locale', 'name_native': 'Multi-locale', 'platforms': {'ios': {'download_url': '#'}}}],
